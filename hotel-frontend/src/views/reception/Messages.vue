<template>
  <div>
    ...
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 20px; flex-wrap: wrap;">
      ...
      <el-select v-model="filterMsgType" placeholder="留言类型" clearable @change="getList" style="width: 140px;">
      ...
      <el-select v-model="filterIsRead" placeholder="已读状态" clearable @change="getList" style="width: 120px;">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      if (this.filterIsRead !== null && this.filterIsRead !== '') params.isRead = this.filterIsRead;
